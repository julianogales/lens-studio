 ...
 * // Instead, you should modify the "Cat Facts API" script and access the functions through the imported class wrapper.
*/

/*
 * @param {RemoteApiResponse} response A raw API response from an Cat Facts API
...
ApiModule.prototype.fact = function(cb) {
